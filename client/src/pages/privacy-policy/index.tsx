    ...
    <article className='mx-auto max-w-3xl space-y-8 rounded-lg bg-white px-6 py-8 shadow-sm sm:px-10'>
      <header className='space-y-4 border-b border-violet-100 pb-6'>
        ...
        <p className='text-base leading-relaxed'>
          We value your privacy and are committed to protecting it. This Privacy
          Policy explains how we handle your data when you use our online photo
          booth service.
        </p>
      </header>
      <section className='space-y-8'>
        <div className='space-y-3'>
          ...
          <p className='leading-relaxed'>
            ...
            taken using our service are processed locally on your device and are
            not uploaded, saved, or stored on any servers.
          </p>
        </div>
