      ...
      {text && (
        <div className='flex flex-col'>
          <button
            ...
            className='flex items-center justify-between border-b border-violet-700 py-2 text-xs text-gray-600 focus:outline-none'
          ...
          <div
            className={`overflow-hidden transition-all duration-300 ease-in-out ${isTextSettingsExpanded ? 'max-h-250 opacity-100' : 'max-h-0 opacity-0'}`}
          >
